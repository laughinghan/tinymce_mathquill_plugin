...
(function () {
  ...
  var reader = direct.create({
    sources: [
      source("bolt", "tinymce.modern.Theme", ".", mapper.constant("theme")),
      source("bolt", "global!tinymce.Env", ".", mapper.constant("theme")),
      ...
      source("bolt", "tinymce.modern.modes.Iframe", ".", mapper.constant("theme")),
      source("bolt", "tinymce.modern.modes.Inline", ".", mapper.constant("theme")),
      source("bolt", "tinymce.modern.ui.Resize", ".", mapper.constant("theme")),
      source("bolt", "tinymce.modern.ui.ProgressState", ".", mapper.constant("theme")),
      ...
      source("bolt", "tinymce.modern.ui.Toolbar", ".", mapper.constant("theme")),
      source("bolt", "tinymce.modern.ui.Menubar", ".", mapper.constant("theme")),
      source("bolt", "tinymce.modern.ui.ContextToolbars", ".", mapper.constant("theme")),
      source("bolt", "tinymce.modern.ui.A11y", ".", mapper.constant("theme")),
      source("bolt", "tinymce.modern.ui.Sidebar", ".", mapper.constant("theme")),
      source("bolt", "tinymce.modern.ui.SkinLoaded", ".", mapper.constant("theme")),
      source("bolt", "global!tinymce.ui.FloatPanel", ".", mapper.constant("theme")),
      source("bolt", "global!tinymce.ui.Throbber", ".", mapper.constant("theme")),
