...
defineGlobal("2", tinymce.util.Tools);
defineGlobal("3", tinymce.util.VK);
/**
 * NodeType.js
 *
...
defineGlobal("9", tinymce.dom.TreeWalker);
defineGlobal("a", tinymce.dom.RangeUtils);
/**
 * Selection.js
 *
 * Released under LGPL License.
...
defineGlobal("h", tinymce.dom.DOMUtils.DOM);
/**
 * Range.js
 *
 * Released under LGPL License.
...
defineGlobal("f", tinymce.dom.BookmarkManager);
defineGlobal("j", tinymce.Env);
/**
 * TextBlock.js
 *
 * Released under LGPL License.
